											...
											<table class="twelve columns">
												<tr>
													...
													<td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
														...
														<span class="template-label"><?php printf( __( 'Reference ID: %s', 'solidres' ), $display_data['reservation']->code ) ?></span>
													</td>
								...
								<tr>
									<td class="wrapper last">
										...
										<table class="twelve columns">
											<tr>
												<td>
													<h3><?php printf( __( 'Dear %s %s %s', 'solidres' ), $display_data['reservation']->customer_firstname, $display_data['reservation']->customer_middlename, $display_data['reservation']->customer_lastname)  ?></h3>

													<p>&nbsp;</p>

													<p>
														<?php printf( __( 'Thank you for your reservation at %s. Should you have any further questions, please do not hesitate to contact us at any time.', 'solidres'), apply_filters( 'solidres_asset_name', $display_data['asset']->name ) ) ?>
													</p>
										...
										<table class="six columns">
											<tr>
												<td>
													...
													<p><?php echo __( 'Length of stay: ', 'solidres') ?>
														<?php
